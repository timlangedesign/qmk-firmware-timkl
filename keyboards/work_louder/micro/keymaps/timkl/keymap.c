...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    // Layer 0
    LAYOUT(
        KC_MPLY, KC_9,    KC_U,    KC_NO,
        KC_GRAVE,    LALT(KC_COMM), LALT(KC_DOT), KC_LEFT_ALT, // Alt + , and Alt + .
        KC_TAB,    LGUI(KC_COMM), LGUI(KC_DOT), KC_LEFT_GUI, // KC_2 + KC_COMM
        TO(1),   KC_COMM,  KC_DOT, LED_LEVEL
    ),
    // Layer 1
    LAYOUT(
        KC_1,    KC_2,    KC_3,    KC_4,
